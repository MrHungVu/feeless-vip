...
var controller2 = {
  ...
  hide() {
    state4.message = DEFAULT_STATE2.message;
    state4.variant = DEFAULT_STATE2.variant;
    state4.svg = DEFAULT_STATE2.svg;
    state4.open = DEFAULT_STATE2.open;
    state4.autoClose = DEFAULT_STATE2.autoClose;
  },
...
var BlockchainApiController = {
  ...
  async fetchTokenPrice({ addresses }) {
    ...
    const result = await state5.api.post({
...
var EventsController = {
  ...
  async _sendAnalyticsEvent(payload) {
    ...
    try {
      ...
      const isForbiddenError = err instanceof Error && err.cause instanceof Response && err.cause.status === ConstantsUtil.HTTP_STATUS_CODES.FORBIDDEN && !state7.reportedErrors["FORBIDDEN"];
      if (isForbiddenError) {
...
var controller10 = {
  ...
  replaceState(newState) {
    ...
    Object.assign(state15, ref(newState));
  },
  subscribe(callback) {
...
var ApiController = {
  ...
  async fetchFeaturedWallets() {
    ...
    if (featuredWalletIds == null ? void 0 : featuredWalletIds.length) {
      ...
      state18.featured = sortedData;
      state18.allFeatured = sortedData;
    }
  },
  ...
  async fetchWalletsByPage({ page }) {
    ...
    await Promise.allSettled(images.map((id) => ApiController._fetchWalletImage(id)));
    state18.wallets = CoreHelperUtil.uniqueBy([...state18.wallets, ...ApiController._filterOutExtensions(data)], "id").filter((w) => {
      var _a;
  ...
  filterByNamespaces(namespaces) {
    ...
    state18.filteredWallets = state18.wallets.filter((wallet) => {
      var _a;
      return (_a = wallet.chains) == null ? void 0 : _a.some((chain) => caipNetworkIds.includes(chain));
    });
  },
  clearFilterByNamespaces() {
    state18.filteredWallets = [];
  },
  setFilterByNamespace(namespace) {
    if (!namespace) {
      state18.featured = state18.allFeatured;
...
var AssetUtil = {
  ...
  async fetchNetworkImage(imageId) {
    ...
    if (!state19.networkImagePromises[imageId]) {
      state19.networkImagePromises[imageId] = ApiController._fetchNetworkImage(imageId);
    }
    await state19.networkImagePromises[imageId];
...
//# sourceMappingURL=chunk-LI2VV255.js.map
