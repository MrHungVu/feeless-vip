...
// ../node_modules/@tronweb3/tronwallet-adapter-tronlink/lib/esm/utils.js
...
// ../node_modules/@tronweb3/tronwallet-adapter-tronlink/lib/esm/adapter.js
...
var TronLinkAdapter = class extends Adapter {
  ...
  constructor(config = {}) {
    ...
    this._tronLinkMessageHandler = (e) => {
      ...
      if (message.action === "accountsChanged") {
        setTimeout(() => {
          ...
          if ((_a2 = this._wallet) === null || _a2 === void 0 ? void 0 : _a2.ready) {
    ...
    const { checkTimeout = 30 * 1e3, dappIcon = "", dappName = "", openUrlWhenWalletNotFound = true, openTronLinkAppOnMobile = true } = config;
      ...
      try {
        ...
        if (this._supportNewTronProtocol) {
          ...
          try {
            ...
            if (error.code === -32002) {
              message = "The same DApp has already initiated a request to connect to TronLink wallet, and the pop-up window has not been closed.";
            }
            if (error.code === 4001) {
...
//# sourceMappingURL=chunk-JFDTCSIU.js.map
