...
export const WalletDisconnectButton = (_a) => {
    ...
    return (React.createElement(Button, Object.assign({ "data-testid": "wallet-disconnect-button", disabled: disabled || !wallet || !connected, icon: wallet ? wallet.adapter.icon : '', onClick: handleClick }, props), content));
};
